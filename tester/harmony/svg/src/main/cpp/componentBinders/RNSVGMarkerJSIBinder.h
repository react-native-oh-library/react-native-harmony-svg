...
namespace rnoh {
class RNSVGMarkerJSIBinder : public ViewComponentJSIBinder {
  protected:
    facebook::jsi::Object createNativeProps(facebook::jsi::Runtime &rt) override {
        ...
        object.setProperty(rt, "refX", true);
        object.setProperty(rt, "refY", true);
        object.setProperty(rt, "markerHeight", true);
        object.setProperty(rt, "markerWidth", true);
        object.setProperty(rt, "markerUnits", true);
        object.setProperty(rt, "orient", true);
