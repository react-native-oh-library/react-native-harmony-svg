...
namespace rnoh {
class RNSVGTextPathJSIBinder : public ViewComponentJSIBinder {
  protected:
    facebook::jsi::Object createNativeProps(facebook::jsi::Runtime &rt) override {
        ...
        object.setProperty(rt, "href", true);
        object.setProperty(rt, "side", true);
        object.setProperty(rt, "method", true);
        object.setProperty(rt, "midLine", true);
        object.setProperty(rt, "spacing", true);
        object.setProperty(rt, "startOffset", true);
        return object;
    }
