...
RNSVGCommonProps::RNSVGCommonProps(const PropsParserContext &context, const RNSVGCommonProps &sourceProps,
                                   const RawProps &rawProps)
    : ViewProps(context, sourceProps, rawProps), name(convertRawProp(context, rawProps, "name", sourceProps.name, {})),
